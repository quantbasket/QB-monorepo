          ...
          <div className="w-full px-4 py-3">
            <div className="flex items-center justify-between w-full">
              <div className="flex items-center space-x-6">
                <h1 className={`text-2xl font-bold ${isDarkMode ? 'text-slate-300' : 'text-foreground'}`}>
                  Dashboard
                </h1>
                ...
                <div className={`flex items-center space-x-0 p-1 rounded-lg ${
                  ...
                  <Button
                    variant={dashboardType === 'community' ? 'dashboardCommunity' : 'ghost'}
                    size="sm"
                  ...
                  <Button
                    variant={dashboardType === 'impact' ? 'dashboardImpact' : 'ghost'}
                    size="sm"
                  ...
                  <Button
                    variant={dashboardType === 'quant' ? 'dashboardQuant' : 'ghost'}
                    size="sm"
                  ...
                  <Button
                    variant={dashboardType === 'portfolio' ? 'dashboardPortfolio' : 'ghost'}
                    size="sm"
              ...
              <div className="flex items-center space-x-4">
                <Select value={selectedCurrency} onValueChange={setSelectedCurrency}>
                  <SelectTrigger className={`w-24 ${isDarkMode 
                    ? 'bg-slate-800 border-slate-600 text-foreground' 
                  ...
                  <SelectContent className={isDarkMode 
                    ...
                    {currencies.map(currency => (
                      <SelectItem 
                        key={currency.code} 
                        value={currency.code}
                        className={isDarkMode ? 'text-foreground hover:bg-slate-700' : 'text-foreground hover:bg-muted'}
                      >
          ...
          {dashboardType === 'community' ? (
            <Tabs value={selectedTab} onValueChange={setSelectedTab} className="space-y-6">
              <TabsList className={`grid w-full grid-cols-8 ${isDarkMode 
                ...
                : 'bg-gradient-to-r from-dashboard-community/10 to-dashboard-impact/10 border border-dashboard-community/20'
              }`}>
                <TabsTrigger value="overview" className="data-[state=active]:bg-gradient-to-r data-[state=active]:from-dashboard-community data-[state=active]:to-dashboard-impact data-[state=active]:text-white">Overview</TabsTrigger>
                <TabsTrigger value="performance" className="data-[state=active]:bg-gradient-to-r data-[state=active]:from-dashboard-community data-[state=active]:to-dashboard-impact data-[state=active]:text-white">Performance</TabsTrigger>
                <TabsTrigger value="holdings" className="data-[state=active]:bg-gradient-to-r data-[state=active]:from-dashboard-community data-[state=active]:to-dashboard-impact data-[state=active]:text-white">My Holdings</TabsTrigger>
                <TabsTrigger value="activity" className="data-[state=active]:bg-gradient-to-r data-[state=active]:from-dashboard-community data-[state=active]:to-dashboard-impact data-[state=active]:text-white">Activity</TabsTrigger>
                <TabsTrigger value="governance" className="data-[state=active]:bg-gradient-to-r data-[state=active]:from-dashboard-community data-[state=active]:to-dashboard-impact data-[state=active]:text-white">Governance</TabsTrigger>
                <TabsTrigger value="engage" className="data-[state=active]:bg-gradient-to-r data-[state=active]:from-dashboard-community data-[state=active]:to-dashboard-impact data-[state=active]:text-white">Engage</TabsTrigger>
                <TabsTrigger value="tokenomics" className="data-[state=active]:bg-gradient-to-r data-[state=active]:from-dashboard-community data-[state=active]:to-dashboard-impact data-[state=active]:text-white">Tokenomics</TabsTrigger>
                <TabsTrigger value="contract" className="data-[state=active]:bg-gradient-to-r data-[state=active]:from-dashboard-community data-[state=active]:to-dashboard-impact data-[state=active]:text-white">Contract</TabsTrigger>
              </TabsList>
